    ...
    <main className="min-h-screen bg-background flex items-center justify-center p-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">Recupera la teva contrasenya</p>
        </div>
        ...
        {enviat ? (
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              {cargando ? 'Enviant...' : 'Enviar email de recuperació →'}
            </button>
            <a href="/auth/login" className="text-center text-sm text-muted-foreground hover:text-foreground">
              ← Tornar al login
            </a>
          </div>
        )}
